...
export interface IVehicle extends VehicleIdentifiers {
  techRecord: TechRecord[];
}

export interface IHeavyGoodsVehicle extends IVehicle {
  techRecord: HgvTechRecord[];
}

export interface ILargeGoodsVehicle extends IVehicle {
  techRecord: CarLgvTechRecord[];
}

export interface IPublicServiceVehicle extends IVehicle {
  techRecord: PsvTechRecord[];
}

export interface ICarVehicle extends IVehicle {
  techRecord: CarLgvTechRecord[];
}

export interface ITrailerVehicle extends IVehicle {
  techRecord: TrlTechRecord[];
}

export interface IMotorcycleVehicle extends IVehicle {
